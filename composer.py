...
parser.add_argument(
    "--decomposer",
    type=str,
    default="saved/vector_depth_state_decomp_0.001lr_0.1lights/state.t7",
    help="decomposer network state file",
)
parser.add_argument(
    "--shader",
    type=str,
    default="saved/vector_shader_0.01/model.t7",
...
parser.add_argument(
    "--num_val", type=int, default=10, help="number of validation images"
)
parser.add_argument(
    "--lights_mult", type=float, default=1, help="multiplier on lights loss"
)
parser.add_argument(
    "--un_mult", type=float, default=1, help="multipler on reconstruction loss"
)
parser.add_argument(
    "--lab_mult",
    type=float,
...
parser.add_argument(
    "--save_model", type=bool, default=True, help="whether to save model or not"
)
parser.add_argument(
    "--transfer",
    type=str,
    default="10-normals,shader_10-shader",
...
parser.add_argument(
    "--set_size", type=int, default=10000, help="number of images per training dataset"
)
parser.add_argument(
    "--val_offset",
    type=int,
...
parser.add_argument(
    "--epoch_size", type=int, default=3200, help="number of images in an epoch"
)
...
train_set = pipeline.ComposerDataset(
    args.data_path,
    args.unlabeled,
    args.labeled,
