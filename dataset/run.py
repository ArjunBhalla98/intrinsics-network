...
parser.add_argument(
    "--repeat", default=2, type=int, help="number of renderings per object"
)
parser.add_argument(
    "--category",
    default="car",
...
parser.add_argument(
    "--script", default="render.py", type=str, help="script run within blender"
)
parser.add_argument(
    "--include", default=None, help="directory to include in python path"
)
...
def render(script, low, high, repeat, category, output):
    ...
    command = [
        "/om/user/janner/blender-2.76b-linux-glibc211-x86_64/blender",
        "--background",
        "-noaudio",
        "--python",
        script,
