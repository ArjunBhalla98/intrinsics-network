...
parser.add_argument(
    "--repeat", default=10, type=int, help="number of renderings per object"
)
parser.add_argument(
    "--division", default=10, type=int, help="number of images per SLURM job"
)
parser.add_argument(
    "--qos", default=False, type=bool, help="whether to use quality-of-service queue"
)
parser.add_argument(
    "--jobs",
    default=None,
    help="list of (low, high) indices to render, overrides {low,high,repeat,division}",
)
parser.add_argument(
    "--script", default="run.py", type=str, help="script to launch blender job"
)
parser.add_argument(
    "--mode", default="render.py", type=str, help="script run within blender"
)
parser.add_argument(
    "--category",
    default="car",
